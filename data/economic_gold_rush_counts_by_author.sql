-- Counting authors in economic gold rush frameby how many distinct articles they've written.
-- We're not bothering to try to split authors using SQL, because the data is too messy.
-- There are authors split by semicolons, authors split by commas, authors with commas separating
